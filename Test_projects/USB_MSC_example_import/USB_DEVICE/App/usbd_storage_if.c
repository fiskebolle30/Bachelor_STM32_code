...
#undef STORAGE_BLK_NBR //Above macros will be regenerated to default values, since it is not user code.
#define STORAGE_BLK_NBR 2000

uint8_t buffer[STORAGE_BLK_NBR*STORAGE_BLK_SIZ];//100 kb buffer (this is the exposed USB storage)
...
const int8_t STORAGE_Inquirydata_HS[] = {/* 36 */
  ...
  0x00,
  0x00,
  'S', 't', 'e', 'i', 'n', 'a', 'r', ' ', /* Manufacturer : 8 bytes */

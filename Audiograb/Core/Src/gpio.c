...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(HSE24_EN_GPIO_Port, HSE24_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, RPI_CM_ENABLE_Pin|RPI_GLOBAL_EN_Pin|RPI_RUN_PG_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PC13 PC15 PC0 PC1
                           PC2 PC3 V_IN_MEAS_Pin V_IMON_Pin
                           PC7 */
  GPIO_InitStruct.Pin = GPIO_PIN_13|GPIO_PIN_15|GPIO_PIN_0|GPIO_PIN_1
                          |GPIO_PIN_2|GPIO_PIN_3|V_IN_MEAS_Pin|V_IMON_Pin
                          |GPIO_PIN_7;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : HSE24_EN_Pin */
  GPIO_InitStruct.Pin = HSE24_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(HSE24_EN_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : RPI_CM_ENABLE_Pin RPI_GLOBAL_EN_Pin RPI_RUN_PG_Pin */
  GPIO_InitStruct.Pin = RPI_CM_ENABLE_Pin|RPI_GLOBAL_EN_Pin|RPI_RUN_PG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

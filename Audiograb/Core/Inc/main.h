...
/* Private defines -----------------------------------------------------------*/
#define HSE24_EN_Pin GPIO_PIN_10
#define HSE24_EN_GPIO_Port GPIOF
#define V_IN_MEAS_Pin GPIO_PIN_4
...
#define RPI_GLOBAL_EN_GPIO_Port GPIOE
#define RPI_RUN_PG_Pin GPIO_PIN_13
#define RPI_RUN_PG_GPIO_Port GPIOE
#define USB_RESET_Pin GPIO_PIN_14
